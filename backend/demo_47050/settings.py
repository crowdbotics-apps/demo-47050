"""
Django settings for demo_47050 project.
...
WSGI_APPLICATION = 'demo_47050.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_47050 API",
    "DESCRIPTION": "API documentation for demo_47050 App",
    "VERSION": "v1",
}
